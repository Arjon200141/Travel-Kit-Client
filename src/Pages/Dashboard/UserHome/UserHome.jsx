            ...
            <div className="flex justify-between mx-8">
                <div className=" bg-white/35 shadow-2xl px-12 rounded-xl">
                    ...
                    <div>
                        <div className="avatar">
                            <div className="w-64 rounded-full ml-2">
                ...
                <div className="mt-16 ">
                    ...
                    <div className="space-y-3 mt-8">
                        ...
                        <h2 className="text-2xl flex gap-3 items-center"><MdRateReview /><span className="font-semibold">Your Reviews : </span>{cart.length}</h2>
                        <h2 className="text-2xl flex gap-3 items-center"><MdPayments /><span className="font-semibold">Your Payments : </span>{cart.length}</h2>
                    </div>
                    </div>
                </div>
            </div>
