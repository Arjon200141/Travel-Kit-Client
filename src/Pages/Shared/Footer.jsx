...
const Footer = () => {
    return (
        <div className="bg-sky-200">
            <footer className="footer p-4  text-base-content">
                <aside className="ml-8">
                    <div className="flex gap-4 items-center mt-6">
                        <img src="https://i.ibb.co/PcrY4rf/images.jpg" alt="" className="h-12 w-12 rounded-full ml-10" />
                        <h2 className="text-3xl font-semibold">TRAVEL KIT</h2>
                    </div>
                    <div className="ml-12 space-y-3 mt-4 text-md">
                    <p className="flex gap-3 items-center"><MdEmail /> travelkit12@gmail.com</p>
            ...
            <hr />
            <footer className="footer footer-center text-lg  p-2 bg-sky-200 text-base-content">
                <aside>
                    <p>Copyright © 2024 - All right reserved by Travel Kit</p>
                </aside>
            </footer>
        </div>
    );
